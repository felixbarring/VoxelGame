...
public:
   ...
   *
   * All batches will be cleared and not drawn again after calling this
   * function.
   */
  void draw();

  /**
   * \brief Sets the sun strength that will affect how bright color the batches
   * will have.
   *
   * @param value The value of the sun strength. The value should be in the
   * range (0, 1) where 0 means no sunlight
