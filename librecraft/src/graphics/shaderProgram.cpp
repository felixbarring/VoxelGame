...
ShaderProgram::ShaderProgram(const string& vertexSource,
  ...
  for (pair<const string, int> attribute : attributes) {
    ...
    switch (errorCheck) {
      ...
      case GL_INVALID_OPERATION:
        cout << " ################################################\n\n";
        cout << "Error, glBindAttribLocation gave a GL_INVALID_OPERATION "
                "error. \n";
        cout << "  Faulty attribute is = " << attribute.first.c_str() << "\n\n";
        cout << vertexSource;
        cout << fragmentSource;
  ...
  for (int i = 0; i < numberOfUniforms; ++i) {
    ...
    // cout << "Inserted new Uniform with name :" << name << ", and location: "
    // << uniformLocation << "\n ";
    ...
    switch (errorCheck) {
      ...
      case GL_INVALID_VALUE:
        ...
        return;
      case GL_INVALID_OPERATION:
        cout << "Error, glGetUniformLocation gave a GL_INVALID_OPERATION "
                "error. \n";
        return;
    }
  }
