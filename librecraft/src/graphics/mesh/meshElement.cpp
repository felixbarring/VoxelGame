...
MeshElement::MeshElement(const std::vector<float> &vbd1,  int vbd1Format, const std::vector<short> &elementData)
{
...
MeshElement::MeshElement(const std::vector<float> &vbd1,  int vbd1Format, const std::vector<float> &vbd2,
		int vbd2Format, const std::vector<short> &elementData)
{
	numberOfElements = elementData.size();
	const static int FLOAT_SIZE = (sizeof(float));
...
MeshElement::MeshElement(const std::vector<float> &vbd1,  int vbd1Format,
		...
		const std::vector<float> &vbd3,  int vbd3Format, const std::vector<short> &elementData)
{
	numberOfElements = elementData.size();
	const static int FLOAT_SIZE = (sizeof(float));
...
MeshElement::MeshElement(const std::vector<float> &vbd1,  int vbd1Format,
		...
		const std::vector<float> &vbd4,  int vbd4Format, const std::vector<short> &elementData)
{
	numberOfElements = elementData.size();
	const static int FLOAT_SIZE = (sizeof(float));
