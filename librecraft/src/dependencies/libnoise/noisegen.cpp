...
double
noise::GradientNoise3D(double fx,
                       double fy,
                       double fz,
                       int ix,
                       int iy,
                       ...
                       int seed)
{
  ...
  return ((xvGradient * xvPoint) + (yvGradient * yvPoint) +
          (zvGradient * zvPoint)) *
         2.12;
}

int
noise::IntValueNoise3D(int x, int y, int z, int seed)
{
...
double
noise::ValueNoise3D(int x, int y, int z, int seed)
{
