...
public:
  ...
  const double* GetControlPointArray() const { return m_pControlPoints; }
  ...
  /// control points.
  void InvertTerraces(bool invert = true) { m_invertTerraces = invert; }
  ...
  ///   inverted.
  bool IsTerracesInverted() const { return m_invertTerraces; }
