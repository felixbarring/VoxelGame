...
public:
  ...
  double GetXTranslation() const { return m_xTranslation; }
  ...
  double GetYTranslation() const { return m_yTranslation; }
  ...
  double GetZTranslation() const { return m_zTranslation; }
  ...
  /// of the input value by a translation amount before returning the
  /// output value from the source module
  void SetTranslation(double xTranslation,
                      double yTranslation,
                      double zTranslation)
  {
  ...
  /// of the input value by a translation amount before returning the
  /// output value from the source module
  void SetXTranslation(double xTranslation) { m_xTranslation = xTranslation; }
  ...
  /// of the input value by a translation amount before returning the
  /// output value from the source module
  void SetYTranslation(double yTranslation) { m_yTranslation = yTranslation; }
  ...
  /// of the input value by a translation amount before returning the
  /// output value from the source module
  void SetZTranslation(double zTranslation) { m_zTranslation = zTranslation; }
