...
void
Curve::AddControlPoint(double inputValue, double outputValue)
{
...
int
Curve::FindInsertionPos(double inputValue)
{
  int insertionPos;
...
double
Curve::GetValue(double x, double y, double z) const
{
  ...
  return CubicInterp(m_pControlPoints[index0].outputValue,
...
void
Curve::InsertAtPos(int insertionPos, double inputValue, double outputValue)
{
